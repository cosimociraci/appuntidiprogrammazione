...
* urgente */ SELECT datname, age(datfrozenxid) AS xid_age,
...
* (autovacuum_freeze_max_age = 100000000); /* Se l'età è già critica (> 150M),
* eseguo un freeze manuale in orario notturno */ VACUUM FREEZE VERBOSE my_table;
* /* Monitoro le tabelle più "anziane" per pianificare i freeze prioritari */
...
* age(datfrozenxid) supera 500M, invio una notifica */ SELECT datname FROM
* pg_database WHERE age(datfrozenxid) > 500000000;
```
