...
" /> 
//   
// <!-- Binding del testo: il designer vede "Nome Cognome", il server inietta il
// valore reale -->
//   <attr sel="#user-name" th:text="$
{user.fullName}
" /> 
//   
//   <!-- Classe CSS dinamica basata sul ruolo --> 
//   <attr sel="#user-role" th:text="$
{user.role}
" th:class="'badge ' + $
{user.roleBadgeClass}
" /> 
...
// Abilito la lettura del file .th.xml parallelo resolver.setCacheable(false); 
// Disabilito in sviluppo return resolver; }
 }
...
{ model.addAttribute("user", userService.findById(id)); return "user-profile"; 
