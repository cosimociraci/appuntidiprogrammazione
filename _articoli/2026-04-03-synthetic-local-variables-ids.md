...
sintesi: "In loop complessi, generare ID univoci per l'accessibilit (ARIA) o per JS  difficile. L'oggetto #ids.seq('myId') genera una sequenza incrementale che persiste per tutta la richiesta. Questo garantisce che i tag label e input siano sempre sincronizz"
tech: "thymeleaf"
