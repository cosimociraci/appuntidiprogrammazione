...
```db
/* Sulla replica intermedia (Hub regionale) */ primary_conninfo = 'host=master_italy port=5432 user=rep_user';
...
/* Le repliche locali si collegano a questo hub, non al master originale */ primary_conninfo = 'host=hub_usa port=5432 user=rep_user';
