...
/* Verifica del leader via etcd */
 # etcdctl get /service/pg-cluster/leader 
/* Script STONITH chiamato da Patroni prima della promozione */
 aws ec2 revoke-security-group-ingress --group-id sg-xxx --protocol tcp --port
5432 --source-group sg-app-servers;
/* Stato post-failover */
