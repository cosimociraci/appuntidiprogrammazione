...
```db
/* Eseguo la query con BUFFERS per vedere il comportamento reale sull'I/O. La prima esecuzione avrà molti 'read' (cold cache), la seconda avrà molti 'hit' (warm cache). */
EXPLAIN (
  ANALYZE,
  BUFFERS,
  FORMAT TEXT
